...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DB.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\DB\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DB.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DB\\Publisher');
        $this->setPackage('DB');
    ...
    {
        $this->addRelation('Book', '\\DB\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DB\Publisher) { // it's a model object
